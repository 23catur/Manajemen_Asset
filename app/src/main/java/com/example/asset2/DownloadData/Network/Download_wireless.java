...
public class Download_wireless extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DownloadDataTask().execute(
                "https://jdksmurf.com/BUMA/Export_wireless.php",
                "WIRELESS.xlsx",
                "merk",
                "hostname",
                "serialnumber",
    ...
    private class DownloadDataTask extends AsyncTask<String, Void, List<DataItem>> {
        ...
        protected void onPostExecute(List<DataItem> dataList) {
            if (dataList != null) {
                ...
                Intent intent = new Intent(Download_wireless.this, Data_wireless.class);
                startActivity(intent);
                finish(); // Menutup aktivitas saat ini agar tidak dapat dikembalikan dengan tombol "back"
            } else {
                Toast.makeText(Download_wireless.this, "Gagal mengunduh data", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void exportData(List<DataItem> dataList, String fileName) {
        ...
        if (isExternalStorageWritable()) {
            ...
            try (Workbook workbook = new XSSFWorkbook()) {
                ...
                String[] headers = {"HOSTNAME", "MERK", "SERIAL NUMBER", "IP", "DEPARTMENT", "LOKASI", "TANGGAL", "KETERANGAN"};
