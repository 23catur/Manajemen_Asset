...
public class Download_komputer extends AppCompatActivity {
    ...
    private class DownloadDataTask extends AsyncTask<String, Void, List<DataItem>> {
        ...
        protected void onPostExecute(List<DataItem> dataList) {
            if (dataList != null) {
                ...
                Intent intent = new Intent(Download_komputer.this, Data_komputer.class);
                startActivity(intent);
                finish();
            } else {
                Toast.makeText(Download_komputer.this, "Gagal mengunduh data", Toast.LENGTH_SHORT).show();
            }
        }
