...
public class CLV_mobile extends ArrayAdapter<String> {
    ...
    public CLV_mobile(Activity context, ArrayList<String> Bumaasset, ArrayList<String> Serialnumber, ArrayList<String> Status, ArrayList<String> Keterangan, ArrayList<String> Foto) {
