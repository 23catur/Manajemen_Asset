...
import com.example.asset2.Updatedata.FMS.Update_mobile;
import com.example.asset2.Updatedata.Network.Update_wireless;

import java.util.ArrayList;
import java.util.List;

public class CLV_mobile extends ArrayAdapter<String> {
    ...
    public CLV_mobile(Activity context, ArrayList<String> Bumaasset, ArrayList<String> Serialnumber, ArrayList<String> Status, ArrayList<String> Keterangan) {
        super(context, R.layout.clv_mobile, Bumaasset);
...
//        this.vFoto          = Foto;
    ...
    public void updateData(ArrayList<String> Bumaasset, ArrayList<String> Serialnumber, ArrayList<String> Status, ArrayList<String> Keterangan) {
        // Clear existing data
        vBumaasset.clear();
        vSerialnumber.clear();
        vStatus.clear();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.clv_mobile, null, true);
