...
public class CLV_ht extends ArrayAdapter<String>  {
    ...
    public CLV_ht(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
