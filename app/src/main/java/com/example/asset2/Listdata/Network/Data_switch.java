...
public class Data_switch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listData = findViewById(R.id.LV_switch);
        ...
        initializeArray();
        adapter = new CLV_switch(Data_switch.this, array_hostname, array_merk, array_serialnumber, array_ip, array_tanggal, array_keterangan, array_foto, array_department, array_lokasi);
    ...
    public void getData(){
        initializeArray();
        AndroidNetworking.post("https://jdksmurf.com/BUMA/getdata_switch.php")
                .setTag("Get Data")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                if (adapter == null) {
                                    adapter = new CLV_switch(Data_switch.this,array_hostname,array_merk,array_serialnumber,array_ip,array_department,array_lokasi,array_tanggal,array_keterangan,array_foto);
                                    listData.setAdapter(adapter);
                                } else {
                                ...
                                Toast.makeText(Data_switch.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
                    ...
                    public void onError(ANError anError) {
                        if (anError.getErrorCode() != 0) {
                            ...
                            Toast.makeText(Data_switch.this, "Error: " + anError.getErrorDetail(), Toast.LENGTH_SHORT).show();
                        } else {
                            Log.e("Error", "onError: " + anError.getErrorDetail());
                            Toast.makeText(Data_switch.this, "Error: " + anError.getErrorDetail(), Toast.LENGTH_SHORT).show();
                        }
