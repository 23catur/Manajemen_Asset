...
import com.example.asset2.Updatedata.Network.Update_switch;
import com.squareup.picasso.Picasso;
import java.util.ArrayList;
import java.util.List;

public class CLV_switch extends ArrayAdapter<String>  {
    ...
    public CLV_switch(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
        super(context, R.layout.clv_switch, Hostname);
    ...
    public void updateData(ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
        vHostname.clear();
        vMerk.clear();
        vSerialnumber.clear();
        vIp.clear();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.clv_switch, null, true);

        CardView update = rowView.findViewById(R.id.cvSwitch);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Update_switch.class);
                ...
                if (vHostname != null && vMerk != null && vSerialnumber != null && vIp != null && vTanggal != null && vKeterangan != null) {
                    if (constraint != null && constraint.length() > 0) {
                        ...
                        for (int i = 0; i < originalData.size(); i++) {
                            if (i < vHostname.size() && i < vMerk.size() && i < vSerialnumber.size() && i < vIp.size() && i < vDepartment.size() && i < vLokasi.size()&& i < vTanggal.size() && i < vKeterangan.size()) {
                                ...
                                if (hostname != null && merk != null && serialNumber != null && ip != null && department != null && lokasi != null && tanggal != null && keterangan != null) {
                        ...
                        results.values = new FilterResultModel(
                                filteredListHostname, filteredListMerk, filteredListSerialNumber,filteredListIp, filteredListDepartment, filteredListLokasi, filteredListTanggal, filteredListKeterangan);
                    } else {
                        results.count = originalData.size();
                        results.values = new FilterResultModel(
                                new ArrayList<>(vHostname), new ArrayList<>(vMerk), new ArrayList<>(vSerialnumber), new ArrayList<>(vIp), new ArrayList<>(vDepartment), new ArrayList<>(vLokasi), new ArrayList<>(vTanggal), new ArrayList<>(vKeterangan));
                    }
                } else {
                    results.count = 0;
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            try {
                if (results.values != null) {
                    ...
                    vLokasi.clear();
                    vLokasi.addAll(filterResultModel.getFilteredLokasi());                    vTanggal.clear();
    ...
    private static class FilterResultModel {
        ...
        public FilterResultModel(List<String> filteredHostname, List<String> filteredMerk, List<String> filteredSerialNumber, List<String> filteredIp, List<String> filteredTDepartment, List<String> filteredLokasi, List<String> filteredTanggal, List<String> filteredKeterangan) {
