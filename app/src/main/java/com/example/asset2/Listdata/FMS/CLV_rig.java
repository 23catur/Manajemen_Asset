...
public class CLV_rig extends ArrayAdapter<String> {
    ...
    public CLV_rig(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Tanggal, ArrayList<String> Keterangan) {
