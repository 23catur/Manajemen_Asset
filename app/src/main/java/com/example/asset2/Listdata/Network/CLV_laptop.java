...
public class CLV_laptop extends ArrayAdapter<String> {
    ...
    public CLV_laptop(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Tanggal, ArrayList<String> Keterangan) {
