...
public class CLV_wireless extends ArrayAdapter<String>  {
    ...
    public CLV_wireless(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
