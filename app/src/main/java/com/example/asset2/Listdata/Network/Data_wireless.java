...
public class Data_wireless extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_wireless);

        listData = findViewById(R.id.LV_wireless);
        ...
        initializeArray();
        adapter = new CLV_wireless(Data_wireless.this, array_hostname, array_merk, array_serialnumber, array_ip, array_tanggal, array_keterangan, array_foto, array_department, array_lokasi);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                if (adapter == null) {
                                    adapter = new CLV_wireless(Data_wireless.this,array_hostname,array_merk,array_serialnumber,array_ip,array_department,array_lokasi,array_tanggal,array_keterangan,array_foto);
                                    listData.setAdapter(adapter);
                                } else {
