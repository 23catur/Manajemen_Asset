...
public class CLV_cctv extends ArrayAdapter<String>  {
    ...
    public CLV_cctv(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
    ...
    private class ValueFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            try {
                if (vHostname != null && vMerk != null && vSerialnumber != null && vIp != null && vDepartment != null && vLokasi != null && vTanggal != null && vKeterangan != null) {
