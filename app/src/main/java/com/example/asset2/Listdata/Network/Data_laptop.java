...
public class Data_laptop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeArray();
        adapter = new CLV_laptop(Data_laptop.this, array_hostname, array_merk, array_serialnumber, array_user, array_tanggal, array_keterangan, array_foto, array_department, array_lokasi);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                if (adapter == null) {
                                    adapter = new CLV_laptop(Data_laptop.this,array_hostname,array_merk,array_serialnumber,array_user,array_department,array_lokasi,array_tanggal,array_keterangan,array_foto);
                                    listData.setAdapter(adapter);
                                } else {
