...
public class Data_ht extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listData = findViewById(R.id.LV_ht);
        ...
        initializeArray();
        adapter = new CLV_ht(Data_ht.this, array_hostname, array_merk, array_serialnumber, array_ip, array_tanggal, array_keterangan);
...
//        progressDialog.show();
    ...
    public void getData(){
        initializeArray();
        //URL
        AndroidNetworking.post("https://jdksmurf.com/BUMA/getdata_ht.php")
                .setTag("Get Data")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                Toast.makeText(Data_ht.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
                    ...
                    public void onError(ANError anError) {
                        ...
                        if (anError.getErrorCode() != 0) {
                            ...
                            Toast.makeText(Data_ht.this, "Error: " + anError.getErrorDetail(), Toast.LENGTH_SHORT).show();
                        } else {
                            Log.e("Error", "onError: " + anError.getErrorDetail());
                            Toast.makeText(Data_ht.this, "Error: " + anError.getErrorDetail(), Toast.LENGTH_SHORT).show();
                        }
