...
public class CLV_komputer extends ArrayAdapter<String> {
    ...
    public CLV_komputer(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> Ip, ArrayList<String> Tanggal, ArrayList<String> Keterangan) {
