...
import com.example.asset2.Updatedata.Network.Update_komputer;
import com.example.asset2.Updatedata.Network.Update_laptop;
import com.squareup.picasso.Picasso;
import java.util.ArrayList;
import java.util.List;

public class CLV_komputer extends ArrayAdapter<String>  {
    ...
    public CLV_komputer(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> User, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
        super(context, R.layout.clv_komputer, Hostname);
    ...
    public void updateData(ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> User, ArrayList<String> Department, ArrayList<String> Lokasi, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
        vHostname.clear();
        vMerk.clear();
        vSerialnumber.clear();
        vUser.clear();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.clv_komputer, null, true);

        CardView update = rowView.findViewById(R.id.cvKomputer);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Update_komputer.class);
...
//        }
    ...
    private class ValueFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            try {
                if (vHostname != null && vMerk != null && vSerialnumber != null && vUser != null && vDepartment != null && vLokasi != null && vTanggal != null && vKeterangan != null) {
                    if (constraint != null && constraint.length() > 0) {
                        ...
                        for (int i = 0; i < originalData.size(); i++) {
                            if (i < vHostname.size() && i < vMerk.size() && i < vSerialnumber.size() && i < vUser.size() && i < vDepartment.size() && i < vLokasi.size()&& i < vTanggal.size() && i < vKeterangan.size()) {
                                ...
                                if (hostname != null && merk != null && serialNumber != null && user != null && department != null && lokasi != null && tanggal != null && keterangan != null) {
                        ...
                        results.values = new FilterResultModel(
                                filteredListHostname, filteredListMerk, filteredListSerialNumber,filteredListUser, filteredListDepartment, filteredListLokasi, filteredListTanggal, filteredListKeterangan);
                    } else {
                        results.count = originalData.size();
                        results.values = new FilterResultModel(
                                new ArrayList<>(vHostname), new ArrayList<>(vMerk), new ArrayList<>(vSerialnumber), new ArrayList<>(vUser), new ArrayList<>(vDepartment), new ArrayList<>(vLokasi), new ArrayList<>(vTanggal), new ArrayList<>(vKeterangan));
                    }
                } else {
                    results.count = 0;
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            try {
                if (results.values != null) {
                    ...
                    vUser.clear();
                    vUser.addAll(filterResultModel.getFilteredUser());
                    vDepartment.clear();
    ...
    private static class FilterResultModel {
        ...
        public FilterResultModel(List<String> filteredHostname, List<String> filteredMerk, List<String> filteredSerialNumber, List<String> filteredUser, List<String> filteredTDepartment, List<String> filteredLokasi, List<String> filteredTanggal, List<String> filteredKeterangan) {
        ...
        public List<String> getFilteredUser() {
            return filteredUser;
        }
