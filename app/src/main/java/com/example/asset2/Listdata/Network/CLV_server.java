...
import com.example.asset2.Updatedata.Network.Update_server;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.List;

public class CLV_server extends ArrayAdapter<String>  {
    ...
    public CLV_server(Activity context, ArrayList<String> Hostname, ArrayList<String> Merk, ArrayList<String> Serialnumber, ArrayList<String> User, ArrayList<String> Tanggal, ArrayList<String> Keterangan, ArrayList<String> Foto) {
        super(context, R.layout.clv_server, Hostname);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.clv_server, null, true);

        CardView update = rowView.findViewById(R.id.cvServer);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Update_server.class);
