...
public class Switch_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_switch);
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Switch_input.this);
        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bitMap == null) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Switch_input.this);
    ...
    public  void TakePhoto(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(Switch_input.this, authorities, photoFile);
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (bitMap != null) {
                    ...
                    Toast.makeText(Switch_input.this, "Error decoding the picture!", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(Switch_input.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        }
...
//                break;
    ...
    private void ScanQR() {
        IntentIntegrator integrator = new IntentIntegrator(Switch_input.this);
    ...
    void kirimdata(){
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Api_switch.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Switch_input.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(Switch_input.this)
                                        .setMessage("DATA BERHASIL DISIMPAN")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Switch_input.this, NavigasiActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
