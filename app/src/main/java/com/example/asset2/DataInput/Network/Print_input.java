...
public class Print_input extends AppCompatActivity {

    Button btnDaftar, btnScan, btnPhoto;
    TextView Hostname, Merk, Serialnumber, Section, Tanggal, Keterangan, Department, Lokasi;
    PhotoView photoView;
    Bitmap bitMap = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_print);
    ...
    public  void TakePhoto(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(Print_input.this, authorities, photoFile);
...
//                break;
                ...
                if (result != null) {
                    if (result.getContents() != null) {
                        ...
                        if (qrCodeValues.length >= 8) {
                            ...
                            Section.setText(qrCodeValues[3]);
    ...
    private void ScanQR() {
        IntentIntegrator integrator = new IntentIntegrator(Print_input.this);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Print_input.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(Print_input.this)
                                        .setMessage("DATA BERHASIL DISIMPAN")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Print_input.this, NavigasiActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
