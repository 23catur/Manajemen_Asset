...
public class Jasset_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_jasset);
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Jasset_input.this);
        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bitMap == null) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Jasset_input.this);
    ...
    void validasiData(){
        if (!serialnumber.isEmpty() && !status.isEmpty() && !keterangan.isEmpty()){
            kirimdata();
        }else{
    ...
    public  void TakePhoto(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(Jasset_input.this, authorities, photoFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(Jasset_input.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void ScanQR() {
        IntentIntegrator integrator = new IntentIntegrator(Jasset_input.this);
    ...
    void kirimdata(){
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Api_jasset.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Jasset_input.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(Jasset_input.this)
                                        .setMessage("DATA BERHASIL DISIMPAN")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Jasset_input.this, NavigasiActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
