...
public class Komputer_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_komputer);
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Komputer_input.this);
    ...
    public  void TakePhoto(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(Komputer_input.this, authorities, photoFile);
    ...
    private void ScanQR() {
        IntentIntegrator integrator = new IntentIntegrator(Komputer_input.this);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Komputer_input.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(Komputer_input.this)
                                        .setMessage("DATA BERHASIL DISIMPAN")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Komputer_input.this, NavigasiActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
