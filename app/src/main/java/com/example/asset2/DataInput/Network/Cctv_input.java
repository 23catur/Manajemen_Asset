...
public class Cctv_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_cctv);
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Cctv_input.this);
        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bitMap == null) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Cctv_input.this);
    ...
    public  void TakePhoto(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(Cctv_input.this, authorities, photoFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(Cctv_input.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void ScanQR() {
        IntentIntegrator integrator = new IntentIntegrator(Cctv_input.this);
    ...
    void kirimdata(){
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Api_cctv.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Cctv_input.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(Cctv_input.this)
                                        .setMessage("DATA BERHASIL DISIMPAN")
                                        .setCancelable(false)
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Cctv_input.this, NavigasiActivity.class);
                                                startActivity(i);
                                            }
                                        })
                                        .show();
