...
public class Maintenance_komputer extends AppCompatActivity {
...
//    DBHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_maintenance_komputer);
...
//        });
        ...
        btnCPU.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Maintenance_komputer.this, DataCPU.class);
        ...
        btnUPS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_komputer.this, DataUPS.class);
                startActivity(intent);
            }
        });
        ...
        btnMONITOR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_komputer.this, DataMonitor.class);
                startActivity(intent);
            }
        });
        ...
        btnPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_komputer.this, DataPrinter.class);
                startActivity(intent);
            }
        });
        ...
        btnPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_komputer.this, DataIPPhone.class);
                startActivity(intent);
            }
        });
        ...
        btnKeyboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_komputer.this, DataKeymou.class);
                startActivity(intent);
            }
        });
