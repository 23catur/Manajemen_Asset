...
public class Maintenance_print extends AppCompatActivity {
...
//    DBHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_maintenance_print);
...
//        });
        ...
        btnCPU.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Maintenance_print.this, DataCPU.class);
        ...
        btnUPS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_print.this, DataUPS.class);
                startActivity(intent);
            }
        });
        ...
        btnMONITOR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_print.this, DataMonitor.class);
                startActivity(intent);
            }
        });
        ...
        btnPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_print.this, DataPrinter.class);
                startActivity(intent);
            }
        });
        ...
        btnPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_print.this, DataIPPhone.class);
                startActivity(intent);
            }
        });
        ...
        btnKeyboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Tindakan yang akan dijalankan saat Tombol 2 ditekan
                Intent intent = new Intent(Maintenance_print.this, DataKeymou.class);
                startActivity(intent);
            }
        });
