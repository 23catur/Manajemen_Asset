...
public class Update_laptop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Update_laptop", "bitMap: " + bitMap);
    ...
    private void handlePhotoButtonClick() {
        if (bitMap != null) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Update_laptop.this);
    ...
    private void ambilFoto() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(Update_laptop.this, authorities, photoFile);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, fileProvider);

        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivityForResult(intent, REQUEST_TAKE_PHOTO);
        } else {
            Log.e("Update_laptop", "Tidak ada aplikasi kamera yang tersedia");
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            Log.d("Update_laptop", "Foto berhasil diambil, path: " + photoFile.getPath());
            ...
            Log.e("Update_laptop", "Gagal mengambil foto, resultCode: " + resultCode);
        }
    }

    private void muatGambarKeImageView(String imagePath) {
        Log.d("Update_laptop", "Memuat gambar ke dalam ImageView, imagePath: " + imagePath);
        Picasso.get().load("file://" + imagePath).into(photoView);
    }


    public void TakePhoto() {
        Log.d("Update_laptop", "Memulai pengambilan foto");
    ...
    void updateData() {
        ...
        Log.d("Update_laptop", "Mengirim permintaan pembaruan dengan foto: " + foto);
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Update_laptop.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_laptop.this, "Error mengupdate data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
