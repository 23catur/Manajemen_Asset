...
public class Update_server extends AppCompatActivity {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap == null) {
                    ...
                    new AlertDialog.Builder(Update_server.this)
    ...
    private void handlePhotoButtonClick() {
        if (bitMap != null) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Update_server.this);
    ...
    private void ambilFoto() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(Update_server.this, authorities, photoFile);
    ...
    private void hapusData() {
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/delete_server.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Update_server.this, "" + pesan, Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_server.this, "Error menghapus data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    void updateData() {
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Update_server.php")
                .addBodyParameter("hostname", "" + hostname)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_server.this, "Error mengupdate data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
