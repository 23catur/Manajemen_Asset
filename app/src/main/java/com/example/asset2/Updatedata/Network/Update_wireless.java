...
public class Update_wireless extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Update_wireless", "bitMap: " + bitMap);

                if (bitMap == null) {
                    progressDialog.dismiss();
                    new AlertDialog.Builder(Update_wireless.this)
    ...
    private void handlePhotoButtonClick() {
        if (bitMap != null) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Update_wireless.this);
    ...
    private void ambilFoto() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(Update_wireless.this, authorities, photoFile);
        intent.putExtra(MediaStore.EXTRA_OUTPUT, fileProvider);

        if (intent.resolveActivity(getPackageManager()) != null) {
            startActivityForResult(intent, REQUEST_TAKE_PHOTO);
        } else {
            Log.e("Update_wireless", "Tidak ada aplikasi kamera yang tersedia");
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            Log.d("Update_wireless", "Foto berhasil diambil, path: " + photoFile.getPath());
            ...
            Log.e("Update_wireless", "Gagal mengambil foto, resultCode: " + resultCode);
        }
    }

    private void muatGambarKeImageView(String imagePath) {
        Log.d("Update_wireless", "Memuat gambar ke dalam ImageView, imagePath: " + imagePath);
        Picasso.get().load("file://" + imagePath).into(photoView);
    }


    public void TakePhoto() {
        Log.d("Update_wireless", "Memulai pengambilan foto");
    ...
    void validatingData() {
        if (hostname.equals("") || merk.equals("") || serialnumber.equals("") || ip.equals("") || department.equals("") || lokasi.equals("") || tanggal.equals("") || keterangan.equals("")) {
            progressDialog.dismiss();
            Toast.makeText(Update_wireless.this, "Check your input!", Toast.LENGTH_SHORT).show();
        } else {
            updateData();
        }
    }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Update_wireless.this, "" + pesan, Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_wireless.this, "Error menghapus data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/Update_wireless.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_wireless.this, "Error mengupdate data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
