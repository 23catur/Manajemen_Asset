...
public class Update_rig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_rig);
    ...
    private void KonfirmasiHapus() {
        new AlertDialog.Builder(Update_rig.this)
    ...
    private void hapusData() {
        ...
        AndroidNetworking.post("https://jdksmurf.com/BUMA/delete_rig.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Update_rig.this, "" + pesan, Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(ANError anError) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(Update_rig.this, "Error menghapus data", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    void validatingData() {
        if (hostname.equals("") || merk.equals("") || serialnumber.equals("") || ip.equals("") || tanggal.equals("") || keterangan.equals("")) {
            progressDialog.dismiss();
            Toast.makeText(Update_rig.this, "Check your input!", Toast.LENGTH_SHORT).show();
        } else {
            updateData();
        }
    }
